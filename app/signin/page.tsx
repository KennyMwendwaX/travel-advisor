...
export default function Signin() {
  ...
  return (
    <>
      <div className="mx-auto flex flex-col items-center justify-center px-6 py-8 bg-slate-800 md:h-screen lg:py-0">
          ...
          <div className="space-y-4 p-6 sm:p-8 md:space-y-6">
            ...
            <div>
              <button
                ...
                className="mb-2 inline-flex w-full items-center justify-center text-white rounded-lg bg-gray-900 px-4 py-2 hover:bg-gray-800">
